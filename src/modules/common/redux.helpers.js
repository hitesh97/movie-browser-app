// I use these functions to remove some of the repetive task of writing / composing the Reducers
// with constants of various status's
...
// e.g. createAsyncActionCreator('GET_NOW_PLAYING', getNowPlayingMovies, {page: 1})
